...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        {/* ✅ CHANGED: Container layout to properly separate logo and navigation */}
        <Container 
          fluid 
          style={{ 
            maxWidth: '1200px',
            ...
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'space-between' // Changed: space-between instead of regular flex
          }}
        >
          {/* LEFT SIDE - LOGO ONLY */}
          ...
          {/* ✅ CHANGED: Right side wrapper for toggle button and collapse */}
