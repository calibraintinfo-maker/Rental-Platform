...
const Profile = () => {
  ...
  return (
    <div style={{ 
      ...
      {/* ✨ VISIBLE FLOATING PARTICLES - Footer Protected */}
      <div style={{ 
        position: 'fixed', 
        top: 0, 
        left: 0, 
        width: '100%', 
        height: 'calc(100vh - 80px)', // Stops 80px before viewport bottom
        zIndex: 1, 
        pointerEvents: 'none',
        overflow: 'hidden'
      }}>
        {/* Beautiful Medium Particles */}
        {[...Array(8)].map((_, i) => (
          <div
            key={`particle-${i}`}
            style={{
              ...
              borderRadius: '50%',
              background: `radial-gradient(circle, rgba(59, 130, 246, ${Math.random() * 0.4 + 0.3}), rgba(37, 99, 235, ${Math.random() * 0.2 + 0.1}))`,
              left: `${Math.random() * 100}%`,
              top: '110%', // Start below viewport
              animation: `floatUp ${Math.random() * 12 + 18}s linear infinite`,
              animationDelay: `${Math.random() * 15}s`,
              boxShadow: `0 0 ${Math.random() * 4 + 2}px rgba(59, 130, 246, 0.3)`,
            }}
          />
        ))}

        {/* Elegant Small Particles */}
        {[...Array(12)].map((_, i) => (
          <div
            key={`small-${i}`}
            style={{
              ...
              borderRadius: '50%',
              background: `rgba(16, 185, 129, ${Math.random() * 0.3 + 0.2})`,
              left: `${Math.random() * 100}%`,
              top: '110%',
              animation: `floatUp ${Math.random() * 10 + 15}s linear infinite`,
              animationDelay: `${Math.random() * 12}s`,
              boxShadow: `0 0 ${Math.random() * 3 + 1}px rgba(16, 185, 129, 0.4)`,
            }}
          />
        ))}
        ...
        {[...Array(6)].map((_, i) => (
          <div
            ...
            style={{
              ...
              left: `${Math.random() * 100}%`,
              top: '110%',
              animation: `sparkleFloat ${Math.random() * 8 + 12}s linear infinite`,
      ...
      <style>
        {`
          ...
          @keyframes floatUp {
            ...
            100% {
              transform: translateY(-85vh) translateX(${Math.random() * 200 - 100}px) scale(0) rotate(360deg);
              opacity: 0;
            }
          }
